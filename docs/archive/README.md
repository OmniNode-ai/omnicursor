...
Completed plans, session handoffs, capstone artifacts, and reference documents that were useful during development but are no longer part of the active contributor or CI surface.

Nothing here is referenced by code, tests, or CLAUDE.md. Safe to ignore.
